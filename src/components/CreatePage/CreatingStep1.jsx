  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.post('https://localhost:7290/api/Game/CreateGame', formData);
  ...
  return (
    <div className='main-c main-b'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          <strong>Size: </strong>
          <select value={createData.size} onChange={handleChange} name="size">
        ...
        <label>
          ...
          <select value={createData.numberOfTeams} onChange={handleChange} name="numberOfTeams">
